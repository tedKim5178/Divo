...
//        YouTube.Captions.Download captionDownload = youtube.captions().download(captionId).setTfmt(SRT);
//
...
//            YouTube.Captions.Update captionUpdate = youtube.captions().update("snippet", updateCaption, mediaContent);
//
...
//        // Create an API request that specifies that the mediaContent
//        // object is the caption of the specified video.
//        YouTube.Captions.Insert captionInsert = youtube.captions().insert("snippet", captionObjectDefiningMetadata, mediaContent);
//
//        // Set the upload type and add an event listener.
