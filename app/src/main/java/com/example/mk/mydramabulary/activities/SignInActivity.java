...
public class SignInActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("894330957153-3063217qm5bgeog3nkecvjo1d4khb01p.apps.googleusercontent.com")
                .requestEmail()
                .build();

        Log.d(TAG, R.string.google_api_key + ", " + R.string.google_app_id + " , " + R.string.gcm_defaultSenderId + "씨바") ;
    ...
    public void onStart() {
        ...
        OptionalPendingResult<GoogleSignInResult> opr = com.google.android.gms.auth.api.Auth.GoogleSignInApi.silentSignIn(mGoogleApiClient);
        if (opr.isDone()) {
...
//            mStatusTextView.setText(getString(R.string.signed_in_fmt, acct.getDisplayName()));
            Log.d(TAG, "handleSignInResult" + acct.getEmail() + " , " + acct.getId() + " , " + acct.getIdToken() + " , " + acct.getGivenName() + " , " + acct.getFamilyName());
            // 이미지 연결해보자
